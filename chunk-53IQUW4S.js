import{b as se}from"./chunk-OTEGEJ4S.js";import{a as Ne,b as Ve,c as qe,d as Be}from"./chunk-UAIUNSO3.js";import{A as Oe,a as me,b as le,c as he,d as I,e as be,f as ke,h as pe,j as ue,k as _e,l as xe,m as fe,n as Ue,o as Re,p as De,s as Te,t as Se,u as Fe,v as Ae,x as Pe,y as ze,z as Le}from"./chunk-N4EPUFBS.js";import{$ as C,Dc as ye,Ga as v,Ha as K,Ib as ie,Ic as Ce,Jc as Ee,Mc as Ie,Nb as oe,Ob as f,Oc as we,Pb as re,Pc as Me,Q as V,R as q,Ra as S,S as B,Sa as _,Ta as x,U as j,Ua as J,V as G,Va as W,W as b,Wa as h,Xa as i,Ya as o,Za as p,_ as y,a as D,aa as $,ac as de,ba as H,cb as Y,db as ee,eb as k,ga as T,gb as l,gc as U,ha as X,hb as w,ib as M,ka as g,kb as te,lb as F,ma as Q,mb as A,oc as ge,pa as Z,qb as ne,sb as E,tb as ce,ua as s,ub as r,vb as P,xc as ve,zb as ae}from"./chunk-NIG4ULNJ.js";var He=["mat-internal-form-field",""],Xe=["*"],je=(()=>{class c{labelPosition="after";static \u0275fac=function(t){return new(t||c)};static \u0275cmp=v({type:c,selectors:[["div","mat-internal-form-field",""]],hostAttrs:[1,"mdc-form-field","mat-internal-form-field"],hostVars:2,hostBindings:function(t,n){t&2&&E("mdc-form-field--align-end",n.labelPosition==="before")},inputs:{labelPosition:"labelPosition"},attrs:He,ngContentSelectors:Xe,decls:1,vars:0,template:function(t,n){t&1&&(w(),M(0))},styles:[`.mat-internal-form-field {
...
`],encapsulation:2,changeDetection:0})}return c})(),Ge=(()=>{class c{static \u0275fac=function(t){return new(t||c)};static \u0275mod=K({type:c});static \u0275inj=B({imports:[N,Ie]})}return c})();var R=class c{constructor(a){this.http=a}list(){return this.http.get(`${U.apiBaseUrl}/api/v1/users`)}create(a){return this.http.post(`${U.apiBaseUrl}/api/v1/users`,a)}update(a,e){return this.http.patch(`${U.apiBaseUrl}/api/v1/users/${a}`,e)}static \u0275fac=function(e){return new(e||c)(G(de))};static \u0275prov=q({token:c,factory:c.\u0275fac,providedIn:"root"})};var Ye=(c,a)=>a.id;function et(c,a){c&1&&(i(0,"mat-error"),r(1,"E-mail \xE9 obrigat\xF3rio."),o())}function tt(c,a){c&1&&(i(0,"mat-error"),r(1,"Informe um e-mail v\xE1lido."),o())}function nt(c,a){if(c&1&&_(0,et,2,0,"mat-error")(1,tt,2,0,"mat-error"),c&2){let e=l();x(e.createForm.controls.email.hasError("required")?0:e.createForm.controls.email.hasError("email")?1:-1)}}function ct(c,a){c&1&&(i(0,"mat-error"),r(1,"Senha \xE9 obrigat\xF3ria."),o())}function at(c,a){c&1&&(i(0,"mat-error"),r(1,"M\xEDnimo de 8 caracteres."),o())}function it(c,a){if(c&1&&_(0,ct,2,0,"mat-error")(1,at,2,0,"mat-error"),c&2){let e=l();x(e.createForm.controls.password.hasError("required")?0:e.createForm.controls.password.hasError("minlength")?1:-1)}}function ot(c,a){c&1&&p(0,"mat-progress-bar",12)}function rt(c,a){if(c&1&&(i(0,"p",15),r(1),o()),c&2){let e=l();s(),P(e.error())}}function dt(c,a){c&1&&(i(0,"small",23),r(1," Sua conta: n\xE3o \xE9 poss\xEDvel desativar ou remover ROLE_ADMIN aqui. "),o())}function st(c,a){if(c&1){let e=Y();i(0,"div",19)(1,"mat-checkbox",20),k("change",function(n){y(e);let d=l().$implicit,u=l();return C(u.toggleEnabled(d.id,n.checked))}),r(2," Ativo "),o(),i(3,"mat-checkbox",21),k("change",function(n){y(e);let d=l().$implicit,u=l();return C(u.toggleRoleUser(d.id,n.checked))}),r(4," ROLE_USER "),o(),i(5,"mat-checkbox",20),k("change",function(n){y(e);let d=l().$implicit,u=l();return C(u.toggleRoleAdmin(d.id,n.checked))}),r(6," ROLE_ADMIN "),o(),i(7,"button",22),k("click",function(){y(e);let n=l().$implicit,d=l();return C(d.saveRow(n))}),r(8," Salvar "),o()(),_(9,dt,2,0,"small",23)}if(c&2){let e=a,t=l().$implicit,n=l();s(),h("checked",e.enabled)("disabled",n.isSelf(t)),s(2),h("checked",e.roleUser),s(2),h("checked",e.roleAdmin)("disabled",n.isSelf(t)),s(2),h("disabled",n.loading()),s(2),x(n.isSelf(t)?9:-1)}}function mt(c,a){if(c&1&&(i(0,"mat-card",17)(1,"mat-card-content")(2,"div",18),r(3),o(),_(4,st,10,7),o()()),c&2){let e,t=a.$implicit,n=l();s(3),P(t.email),s(),x((e=n.drafts().get(t.id))?4:-1,e)}}var $e=class c{loading=g(!1);error=g(null);users=g([]);drafts=g(new Map);api=b(R);auth=b(se);fb=b(xe);createForm=this.fb.nonNullable.group({email:["",[I.required,I.email]],password:["",[I.required,I.minLength(8)]],roleUser:[!0],roleAdmin:[!1]});constructor(){this.reload()}showCreateErr(a){return a.invalid&&(a.touched||a.dirty)}isSelf(a){return this.auth.getUserId()===a.id}reload(){this.loading.set(!0),this.error.set(null),this.api.list().subscribe({next:a=>{this.users.set(a),this.initDrafts(a),this.loading.set(!1)},error:()=>{this.loading.set(!1),this.error.set("Falha ao carregar usu\xE1rios (permiss\xE3o ou API).")}})}initDrafts(a){let e=new Map;for(let t of a)e.set(t.id,{enabled:t.enabled,roleUser:t.roles.includes("ROLE_USER"),roleAdmin:t.roles.includes("ROLE_ADMIN")});this.drafts.set(e)}patchDraft(a,e){let t=new Map(this.drafts()),n=t.get(a);n&&(t.set(a,D(D({},n),e)),this.drafts.set(t))}toggleEnabled(a,e){this.patchDraft(a,{enabled:e})}toggleRoleUser(a,e){this.patchDraft(a,{roleUser:e})}toggleRoleAdmin(a,e){this.patchDraft(a,{roleAdmin:e})}saveRow(a){let e=this.drafts().get(a.id);if(!e)return;let t=[];if(e.roleUser&&t.push("ROLE_USER"),e.roleAdmin&&t.push("ROLE_ADMIN"),t.length===0){this.error.set("Selecione pelo menos um papel.");return}this.loading.set(!0),this.error.set(null),this.api.update(a.id,{enabled:e.enabled,roles:t}).subscribe({next:()=>this.reload(),error:()=>{this.loading.set(!1),this.error.set("Falha ao atualizar usu\xE1rio (regra de seguran\xE7a ou dados inv\xE1lidos).")}})}create(){if(this.createForm.invalid)return;let a=this.createForm.getRawValue(),e=[];if(a.roleUser&&e.push("ROLE_USER"),a.roleAdmin&&e.push("ROLE_ADMIN"),e.length===0){this.error.set("Selecione pelo menos um papel.");return}this.loading.set(!0),this.error.set(null),this.api.create({email:a.email,password:a.password,roles:e}).subscribe({next:()=>{this.createForm.reset({email:"",password:"",roleUser:!0,roleAdmin:!1}),this.reload()},error:()=>{this.loading.set(!1),this.error.set("Falha ao criar usu\xE1rio (email duplicado ou dados inv\xE1lidos).")}})}static \u0275fac=function(e){return new(e||c)};static \u0275cmp=v({type:c,selectors:[["app-users-page"]],decls:42,vars:7,consts:[[1,"app-feature-page"],[1,"mat-headline-medium","page-title"],[1,"mat-body-medium","app-feature-page__subtitle"],["appearance","outlined",1,"app-feature-panel"],[1,"users-create-form","app-feature-form-stack",3,"ngSubmit","formGroup"],["appearance","outline","subscriptSizing","dynamic"],["matInput","","type","email","formControlName","email","autocomplete","off"],["matInput","","type","password","formControlName","password","autocomplete","new-password"],[1,"roles"],["formControlName","roleUser"],["formControlName","roleAdmin"],["mat-flat-button","","color","primary","type","submit",3,"disabled"],["mode","indeterminate","aria-label","Carregando lista"],[1,"app-feature-panel-head"],["mat-stroked-button","","type","button",3,"click","disabled"],["role","alert",1,"app-contained-alert-error","mat-body-medium"],[1,"user-list"],["appearance","outlined",1,"user-row"],[1,"email-line","mat-title-medium"],[1,"row-controls"],[3,"change","checked","disabled"],[3,"change","checked"],["mat-flat-button","","color","primary","type","button",3,"click","disabled"],[1,"users-row-hint","mat-body-small","app-text-muted"]],template:function(e,t){e&1&&(i(0,"div",0)(1,"header")(2,"h1",1),r(3,"Usu\xE1rios"),o(),i(4,"p",2),r(5,"Apenas administradores podem gerenciar usu\xE1rios."),o()(),i(6,"mat-card",3)(7,"mat-card-header")(8,"mat-card-title"),r(9,"Novo usu\xE1rio"),o()(),i(10,"mat-card-content")(11,"form",4),k("ngSubmit",function(){return t.create()}),i(12,"mat-form-field",5)(13,"mat-label"),r(14,"E-mail"),o(),p(15,"input",6),_(16,nt,2,1),o(),i(17,"mat-form-field",5)(18,"mat-label"),r(19,"Senha (m\xEDn. 8)"),o(),p(20,"input",7),_(21,it,2,1),o(),i(22,"div",8)(23,"mat-checkbox",9),r(24,"ROLE_USER"),o(),i(25,"mat-checkbox",10),r(26,"ROLE_ADMIN"),o()(),i(27,"button",11),r(28," Criar "),o()()()(),i(29,"mat-card",3),_(30,ot,1,0,"mat-progress-bar",12),i(31,"mat-card-header",13)(32,"mat-card-title"),r(33,"Lista"),o(),i(34,"button",14),k("click",function(){return t.reload()}),r(35,"Recarregar"),o()(),p(36,"mat-divider"),i(37,"mat-card-content"),_(38,rt,2,1,"p",15),i(39,"div",16),J(40,mt,5,2,"mat-card",17,Ye),o()()()()),e&2&&(s(11),h("formGroup",t.createForm),s(5),x(t.showCreateErr(t.createForm.controls.email)?16:-1),s(5),x(t.showCreateErr(t.createForm.controls.password)?21:-1),s(6),h("disabled",t.createForm.invalid||t.loading()),s(3),x(t.loading()?30:-1),s(4),h("disabled",t.loading()),s(4),x(t.error()?38:-1),s(2),W(t.users()))},dependencies:[fe,pe,le,be,ke,_e,ue,Se,Ue,De,Te,Re,Me,we,ze,Pe,Fe,Ae,Oe,Le,Ge,N,Ve,Ne,Be,qe],styles:[".users-create-form[_ngcontent-%COMP%]{margin-top:8px}.roles[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:12px 16px;align-items:center;padding:4px 0 8px}.user-list[_ngcontent-%COMP%]{display:grid;gap:12px;margin-top:16px}.email-line[_ngcontent-%COMP%]{margin-bottom:4px}.row-controls[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:12px;align-items:center;margin-top:8px}.users-row-hint[_ngcontent-%COMP%]{display:block;margin-top:8px}"],changeDetection:0})};export{$e as UsersPage};
